...
class HistorialTareas(QMainWindow):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("imagenes/icono1.png"))
        ...
        self.text_edit.setPlaceholderText("Aquí se mostrará el historial de tareas.")
    ...
    def cargar_historial(self):
        try:
            with open("historial_tareas.txt", "r") as file:
                historial = file.read()
                self.text_edit.setPlainText(historial)
        except FileNotFoundError:
            self.text_edit.setPlainText("El historial de tareas está vacío.")
